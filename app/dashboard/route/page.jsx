      ...
      try {
        ...
        for (const docSnapshot of driverSnapshot.docs) {
          ...
          if (driverData) {
            ...
            const routeData = routeMap[driverID];
            const plateNumber = routeData?.plateNumber || "Pending";
            const routeText = routeData?.route || "Not assigned";
